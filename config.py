...
class Config(object):
    ...
    # database config
    DB_NAME = os.environ.get("DB_NAME","Haruto179")     
    ...
    FORCE_SUB_CHANNELS = os.environ.get('FORCE_SUB_CHANNELS', 'MythicBot_Support,Mythic_Bots').split(',')
    LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1002686116676"))
    DUMP_CHANNEL = int(os.environ.get("DUMP_CHANNEL", "-1002604353602"))
